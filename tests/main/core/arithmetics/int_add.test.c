...
static void test_add_positives() {
    CU_ASSERT_EQUAL(
        add(0x0000000000000011ULL /* 17 */, 0x0000000000000019ULL /* 25 */),
...
static void test_add_positives_overflow() {
    CU_ASSERT_EQUAL(
        add(0x6000000000000000ULL /* 6917529027641081856 */, 0x5000000000000000ULL /* 5764607523034234880 */),
...
static void test_add_positive_to_negative() {
    CU_ASSERT_EQUAL(
        add(0xFFFFFFFFFFFFFEFEULL /* -257 */, 0x0000000000000058ULL /* 88 */),
...
static void test_add_positive_to_negative_sign_change() {
    CU_ASSERT_EQUAL(
        add(0xFFFFFFFFFFFFFF90ULL /* -111 */, 0x0000000000000237ULL /* 567 */),
...
static void test_add_negative_to_positive() {
    CU_ASSERT_EQUAL(
        add(0x00000000000003E6ULL /* 998 */, 0xFFFFFFFFFFFFFFB5ULL /* -74 */),
...
static void test_add_negative_to_positive_sign_change() {
    CU_ASSERT_EQUAL(
        add(0x00000000000008C8ULL /* 2248 */, 0xFFFFFFFFFFFFE9F1ULL /* -5646 */),
...
static void test_add_negatives() {
    CU_ASSERT_EQUAL(
        add(0xFFFFFFFFFFFFFFF0ULL /* -15 */, 0xFFFFFFFFFFFFFFE9ULL /* -22 */),
...
static void test_add_negatives_overflow() {
    CU_ASSERT_EQUAL(
        add(0x9FFFFFFFFFFFFFFFULL /* -6917529027641081856 */, 0xAFFFFFFFFFFFFFFFULL /* -5764607523034234880 */),
